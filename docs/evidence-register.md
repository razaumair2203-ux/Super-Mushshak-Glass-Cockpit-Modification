...
| E-05 | Dec 2010 interface/support exchanges | Direct project / OEM exchange | CFG-D2 | retained NAV, transponder, audio/terrain, configuration and maintainability topics | abstracted interface/support claims only |
| E-06 | 2012 performance-test / ADAHRS / EMS exchanges | Direct project / OEM exchange | CFG-D3 | performance-test context; high-rate attitude behaviour; PTT-associated engine-indication issue | technical summary only; final closure not invented |
| E-07 | Nov 2012 customer-evaluation status | Direct project | CFG-D3 | repeated evaluation sorties; 10 sorties including night operation | aggregate evaluation facts only |
| E-08 | 2012 Dynon-vs-Garmin comparison presentation | Direct project | CMP-G3X / trade space | Dynon vs G3X comparative candidate evidence | safe qualitative findings only |
| E-09 | Garmin G900X/G950 installation/maintenance manual excerpt | OEM/reference | CFG-G1 reference | generic Garmin LRU/functions/network architecture | OEM summary only; never relabelled as aircraft wiring |
...
| E-20 | Selected original cockpit-in-flight project photographs | Direct project | Dynon flight/test context | visible installed-aircraft / cockpit / sortie context | **published — privacy/security reviewed**; configuration claim only where visible |
| E-21 | Selected original aerial test-flight photographs | Direct project | flight/test context | terrain, route, cloud/visibility and broader period flight-test / operational-environment context | **published — privacy/security reviewed**; not configuration proof |
